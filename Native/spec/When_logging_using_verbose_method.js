describe('When logging using verbose method', function () {
    ...
    it('Should log severity level critical', function(done) {
        loupe.verbose('test', 'test logs message','test log description including parameter {0}',['test']);
    ...
    it('Should log severity level critical with exception', function(done) {
        ...
        loupe.verbose('test', 'test logs message','test log description including parameter {0}',['test'], suppliedError);        
    ...
    it('Should log severity level verbose with string passed for exception', function(done) {
        loupe.verbose('test', 'test logs message','test log description including parameter {0}',['test'], "Custom error");        
    ...
    it('Should log severity level critical with details', function(done) {
        loupe.verbose('test', 'test logs message','test log description including parameter {0}',['test'], null,"<data>test details</data>");
