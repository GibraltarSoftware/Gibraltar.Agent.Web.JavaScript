describe('When logging using verbose method', function() {
    ...
    it('Should log expected caption & description', inject(function ($httpBackend) {
        ...
        $scope.verbose('information logging','testing logging using information method');
        $httpBackend.flush();
    }));
    ...
    it('Should log expected exception', inject(function ($httpBackend) {
        ...
        $scope.verbose('information logging','testing logging using information method',suppliedException);
        $httpBackend.flush();
    }));
    ...
    it('Should log expected details', inject(function ($httpBackend) {
        ...
        $scope.verbose('information logging','testing logging using information method',null,"<data>details</data>");
        $httpBackend.flush();
    }));            
});