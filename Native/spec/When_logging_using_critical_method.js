describe('When logging using critical method', function () {
    ...
    it('Should log severity level critical with exception', function(done) {
        ...
        loupe.agent.critical('test', 'test logs message','test log description including parameter {0}',['test'], suppliedError);        
    ...
    it('Should log severity level critical with details', function(done) {
        loupe.agent.critical('test', 'test logs message','test log description including parameter {0}',['test'], null,"<data>test details</data>");
